...
import 'package:weather2024/core/widgets/app_background.dart';
import 'package:weather2024/core/widgets/dot_loading_widget.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    BlocProvider.of<HomeBloc>(context).add(LoadCurretWeatherEvent(cityName));
  }
    ...
    return SafeArea(
      ...
      BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
        if (state.cwStatus is CwLoading) {
          return const Expanded(child: const DotLoadingWidget());
        }
